...
static uint32_t colors[][3] = {
    /* fg (foreground/text) */     /* bg (background) */      /* border color */
    /* SchemeNorm: Inactive/Unfocused */
    [SchemeNorm] = { 0xbdae93ff, 0x1d2021ff, 0x1d2021ff },

    /* SchemeSel: Focused/Selected */
    [SchemeSel]  = { 0x181818ff, 0xbdae93ff, 0xbdae93ff },

    /* SchemeUrg: Urgent */
    [SchemeUrg]  = { 0x181818ff, 0xcc241dff, 0xcc241dff },
};
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT|WLR_MODIFIER_CTRL,	XKB_KEY_space,      setlayout,      {0} },
